...
class Results:
    def __init__(self,root='C:/Users/gnana/Attention-KAN-PINN/results/MIT results/'):
        self.root = root
        ...
        for i in range(len(lines)):
            ...
            if '[train] epoch:1 iter:1 data' in line:
                ...
                if 'MSE:' in line:
                    ...
                    # If there is no 'MSE:', skip the current line to avoid IndexError
                else:
                    continue
...
if __name__ == '__main__':
    root = 'C:/Users/gnana/Attention-KAN-PINN/My-MIT_Attention results/Ablation/KAN-PINN results/'
    ...
    writer.save()
    valid_columns = df_mean2.select_dtypes(include=[np.number]).columns  # Select numeric columns
    mean_values = df_mean2[valid_columns].mean()  # Calculate mean
    print(mean_values)
