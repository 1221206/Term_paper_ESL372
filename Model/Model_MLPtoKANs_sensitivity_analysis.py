...
class PINN(nn.Module):
    def __init__(self, args):
        ...
        self.l2_lambda = args.l2_lambda  # default value
    ...
    def Train(self, trainloader, testloader=None, validloader=None):
        ...
        for e in range(1, self.args.epochs + 1):
            ...
            epoch_l2_reg.append(l2_reg)

            info = '[Train] epoch:{}, lr:{:.6f}, total loss:{:.6f}, data loss:{:.6f}, PDE loss:{:.6f}, physics loss:{:.6f}, l2_reg:{:.6f}'.format(
                e, current_lr, total_loss, loss1, loss2, loss3, l2_reg)
        ...
        if self.args.save_folder is not None:
            ...
            np.save(os.path.join(self.args.save_folder, 'epoch_l2_reg.npy'), epoch_l2_reg)
            ...
            with open(summary_path, 'w') as f:
                ...
                f.write(f"  lambda1: {self.lambda1}\n")
                f.write(f"  lambda2: {self.lambda2}\n")
                f.write(f"  lambda3: {self.lambda3}\n")
                f.write(f"  l2_lambda: {self.l2_lambda}\n")
