...
import os
from Model.Model_NN import MLP
...
class PINN(nn.Module):
    def __init__(self, args):
        ...
        self.solution_u = MLP(input_dim=17, output_dim=1, hidden_dim=args.u_hidden_dim,
                              num_hidden_layers=args.u_layers_num, dropout=0.2).to(device)
        self.dynamical_F = MLP(input_dim=35, output_dim=1, hidden_dim=args.F_hidden_dim,
    ...
    def save_model_architecture(self, metrics):
        ...
        with open(architecture_path, 'w') as f:
            f.write("Model: NN-PINN\n\n")
            f.write("Solution_u Network (NN):\n")
            ...
            f.write("Dynamical_F Network (NN):\n")
            f.write(f"Input dimension: 19\n")
            f.write(f"Output dimension: 1\n")
