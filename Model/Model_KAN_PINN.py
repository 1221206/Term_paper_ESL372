...
import os
from Model.Model_MLPtoKANs import KAN
...
class PINN(nn.Module):
    def __init__(self, args):
        ...
        self.solution_u = KAN(input_dim=17, output_dim=1, hidden_dim=args.u_hidden_dim,
    ...
    def save_model_architecture(self, metrics):
        ...
        with open(architecture_path, 'w') as f:
            ...
            f.write("Dynamical_F Network (MLP):\n")
