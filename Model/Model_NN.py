...
class MLP(nn.Module):
    def __init__(self, input_dim=17, output_dim=1, hidden_dim=60, num_hidden_layers=3, dropout=0.0):
...
class Trainer(nn.Module):
    def __init__(self, args):
        ...
        self.model = MLP(input_dim=17, output_dim=1, hidden_dim=args.u_hidden_dim,
