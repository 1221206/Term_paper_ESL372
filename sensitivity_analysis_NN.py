...
def get_args():
    ...
    parser.add_argument('--save_folder', type=str, default='optimized_plots/NN_sensitivity_analysis', help='save folder')
...
def main():
    args = get_args()
    base_folder = 'optimized_plots/NN_sensitivity_analysis'
